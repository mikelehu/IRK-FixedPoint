/*
 * This file automatically produced by /usr/local/Wolfram/Mathematica/11.0/SystemFiles/Links/MathLink/DeveloperKit/Linux-x86-64/CompilerAdditions/mprep from:
 *	math-Gauss.tm
...
# line 32 "math-Gausstm.c"


void mathGauss P(( int _tp1, int _tp2, int _tp3, double _tp4, double _tp5, double * _tp6, long _tpl6, double * _tp7, long _tpl7, double _tp8, double * _tp9, long _tpl9, int * _tp10, long _tpl10, int _tp11, int _tp12, int _tp13, int _tp14, int _tp15, const char * _tp16, int _tp17, int _tp18));
...
#endif
{
	...
	mathGauss(_tp1, _tp2, _tp3, _tp4, _tp5, _tp6, _tpl6, _tp7, _tpl7, _tp8, _tp9, _tpl9, _tp10, _tpl10, _tp11, _tp12, _tp13, _tp14, _tp15, _tp16, _tp17, _tp18);
...
#endif
{
	int _res;
	_res = MLConnect(mlp);
	if (_res) _res = _definepattern(mlp, (char *)"mathGauss [neq_Integer,n_Integer,ns_Integer,t0_Real,tend_Real,u_List,ee_List,h_Real,rpar_List,ipar_List,approximation_Integer,   threads_Integer,algorithm_Integer,rdigits1_Integer,rdigits2_Integer,filename_String,sampling_Integer, codfun_Integer]", (char *)"{neq,n,ns,t0,tend,u,ee,h,rpar,ipar,approximation,threads,algorithm,rdigits1,rdigits2,filename, sampling,codfun}", 0);
